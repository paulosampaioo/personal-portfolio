...
function linkAction(){
    const navMenu = document.getElementById('nav-menu')
    // at time you click on each nav__link, it will remove the show-menu class
    navMenu.classList.remove('show-menu')
}
...
modalCoses = document.querySelectorAll('.services__modal-close')
...
modalCoses.forEach((modalCose) => {
    modalCose.addEventListener('click', () =>{
